# sample script: python testPSMode.py --checkpoint ./checkpoints/ckpt_disp_SSMODE_sphere_Deep360_40_soiled.tar --save_output_path ./outputs/test_ssmode_sphere_soiled_40_b2_192 --soiled
